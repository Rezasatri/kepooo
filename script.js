...
footer.href = "https://www.instagram.com/reza_satria_23/";

document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sayangkuu tercinta", "Abii ada pertanyaan nih buat sayangku?", "question").then(function () {
    Swal.fire("Jawab yang jujur ya Sayangkuu!").then(function () {
      Swal.fire("Awas aja kalo boong!!", "", "error").then(function () {

        const {
          value: name
        } = Swal.fire({
          title: 'Masukin nama sayangku dulu',
          input: 'text',
          inputLabel: '',
                ...
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`yeee iya ${sender} juga kangen ${nama} :((`).then(function () {
                          Swal.fire('Terakhir deh sayang').then(function () {
                            Swal.fire('Coba klik gambar hati di paling bawah dong sayangku')
                          })
                        })
                      } else if (result.isDenied) {
                        Swal.fire('Jahat banget ayangg ga kangen sama ${sender}', '', 'error').then(function () {
